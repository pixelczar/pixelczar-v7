    ...
    <header className="flex items-center justify-between p-6 theme-transition">
      ...
      >
        <motion.div variants={navItemVariants}>
          <MagneticLink
            href="/about"
            className={`text-base font-sans font-normal transition-all duration-300 relative px-3 py-1 rounded-full hover:text-white hover:bg-accent/10 ${pathname === "/about" ? "font-medium" : "hover:text-primary"
              }`}
        ...
        <motion.div variants={navItemVariants}>
          <MagneticLink
            href="/work"
            className={`text-base font-sans font-normal transition-all duration-300 relative px-3 py-1 rounded-full hover:text-white hover:bg-accent/10 ${pathname === "/work" ? "font-medium" : "hover:text-primary"
              }`}
        ...
        <motion.div variants={navItemVariants}>
          <MagneticLink
            href="/labs"
            className={`text-base font-sans font-normal transition-all duration-300 relative px-3 py-1 rounded-full hover:text-white!important hover:bg-accent/10 ${pathname === "/labs" ? "font-medium" : "hover:text-primary"
              }`}
            style={pathname === "/labs" ? { color: 'hsl(var(--accent))', opacity: 1 } : { color: 'var(--muted-foreground)' }}
            data-cursor-rounded="full"
            strength={0.3}
          >
            Labs
            ...
            >
              {[
                ...
                <motion.div key={item.href} variants={menuItemVariants}>
                  <MagneticLink
                    href={item.href}
                    className={`text-7xl font-sans tracking-tight font-light transition-all duration-300 relative px-4 py-2 ${pathname === item.href ? "text-accent" : "hover:text-accent"
                      }`}
